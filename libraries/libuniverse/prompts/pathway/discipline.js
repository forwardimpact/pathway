...
export function buildDisciplinePrompt(skeleton, ctx, schema) {
  return {
    ...
    user: [
      ...
      "- human.professionalRoleSummary: 2-3 sentences for IC role. May use {roleTitle}.",
      "- human.managementRoleSummary: 2-3 sentences for management role. May use {specialization}.",
