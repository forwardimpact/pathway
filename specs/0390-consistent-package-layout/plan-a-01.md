...
// to the allowed-root-subdirs contract (spec 0390).
...
if (violations.length || rootSourceFiles.length) {
  console.error("Package layout drift detected (spec 0390):\n");
...
spec 0390 and any root-level source file. Permissive by default — the
