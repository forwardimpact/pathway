...
Spec 0220 (test-guide-product-setup) specifically tests the experience of a new
...
6. The spec 0220 test (test-guide-product-setup) can progress past the install
