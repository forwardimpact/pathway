...
products/map/
  ...
  activity/                         Existing — unchanged
    ...
    extract/                        ELT Extract functions (from spec 0051)
    transform/                      ELT Transform functions (from spec 0051)
    queries/                        Existing query functions
    storage.js                      Raw storage helpers (from spec 0051)
...
### Phase 6 — Integration with ELT (spec 0051)
...
### Phase 7 — Integration with synthetic data (spec 0060)
