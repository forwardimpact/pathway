...
Part 1 of 4 of [plan-a](plan-a.md) for [spec 0400](spec.md).

Renames five `.claude/skills/libs-*` directories so the filesystem reflects the
six task-named groups from spec 0400 Move 1, and updates
...
- Update `CLAUDE.md § Skill Groups` with the new group names, membership, and
  the orphan libraries added in spec 0400 Move 1.
