...
- **Synthetic data injection.** The synthetic data pipeline (spec 0060) needs to
...
- Building the Supabase infrastructure (see spec 0052).
- Modifying the synthetic data pipeline (see spec 0060 plan v3).
