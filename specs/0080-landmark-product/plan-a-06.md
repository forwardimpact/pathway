...
- `specs/STATUS` — advance spec 0080 to `done` (reviewer step, performed last).
...
- Package layout (spec 0390) and how it mirrors Summit.
...
- **Behaviour rendering — explicit non-goal.** Drivers may declare
  ...
  the health view for spec 0080. Rationale: behaviours are maturity profiles
...
A merged PR that completes spec 0080's documentation surface. `specs/STATUS`
