...
| UI framework | `libraries/libui/`                           |
| UI CSS       | `libraries/libui/css/`                       |
...
3. `libraries/libskill/` — Derivation logic if needed
...
**Model** (`libraries/libskill/`): `derivation.js`, `modifiers.js`,
