...
- [ ] **Spec quality approved** (spec PRs only) — apply `kata-spec` review (Step
      5). On failure, mark **blocked** and comment with review findings.
...
[`kata-gh-cli` § Contributor trust lookup](../kata-gh-cli/SKILL.md#contributor-trust-lookup-top-20-gate)):
