...
| Action                            | Files                                                                                                                                                                                                                                                                                                                                                                                                                |
| --------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `actions/checkout`                | check-quality.yml, check-test.yml, check-security.yml, publish-npm.yml, publish-macos.yml, publish-skills.yml (x2), website.yaml, agent-react.yml, agent-product-manager.yml, agent-release-engineer.yml, agent-security-engineer.yml, agent-staff-engineer.yml, agent-technical-writer.yml, kata-coaching.yml, kata-storyboard.yml, interview-\*-setup.yml (x4), kata-action-agent/action.yml, bootstrap/action.yml |
