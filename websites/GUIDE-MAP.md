...
Every guide under `websites/fit/docs/` maps to a Big Hire or Little Hire from
[JTBD.md](../JTBD.md), [libraries/README.md](../libraries/README.md), or
[services/README.md](../services/README.md). Big Hire guides are directory
roots; Little Hire guides are nested children. See
[Page Conventions § Guide Pages](CLAUDE.md#guide-pages) for length budgets and
framing rules.

## Product Guides (`websites/fit/docs/products/`)
...
## Library Guides (`websites/fit/docs/libraries/`)
...
## Service Guides (`websites/fit/docs/services/`)
