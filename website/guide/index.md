...
scaffold created by `fit-guide init`. After setup, configure your LLM
credentials in `.env` and process your framework data — see the
[Getting Started guide for engineers](/docs/getting-started/engineers/#guide)
for the full walkthrough.

Once configured, point Guide at your framework and start asking questions:
